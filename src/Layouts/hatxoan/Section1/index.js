            ...
            <div className="Section1__menu">
                <div className="container">
                    <div className="Section1__menu__inner">
                        <label className="Section1__menu__inner__tab lable1" for="inner1" style={{color:"#FFFFFF"}}>Tín ngưỡng tâm linh nơi cửa đình</label>
                        <label className="Section1__menu__inner__tab lable2" for="inner2" style={{color:"#FFFFFF"}}>Làng Xoan giữ hồn di sản </label>
                        <label className="Section1__menu__inner__tab lable3" for="inner3" style={{color:"#FFFFFF"}}>Trình tự ba phần chặt chẽ </label>
                ...
                <div className="container">
                        ...
                        <div className="Section1__content__inner__row">
                            <div className="Section1__content__inner__row__text">
                                <div className="Section1__content__inner__title" style={{color:"#FFFFFF"}} >
                                    Tín ngưỡng tâm linh nơi cửa đình
                                </div>
                                <div className="Section1__content__inner__text" style={{color:"#FFFFFF"}}>
                                    Hát Xoan, còn có tên gọi là Khúc môn đình (hát cửa đình), là lối hát thờ thần, tương truyền có từ thời các vua Hùng. Hát Xoan là một loại dân ca lễ nghi, phong tục gắn với hội mùa, thờ Thành hoàng. Hát Xoan được tổ chức vào mùa Xuân để đón chào năm mới, cầu trời cho mưa thuận, gió hòa, mùa màng tươi tốt, nhà nhà no đủ, nhân khang vật thịnh, quốc thái dân an.
                                </div>
                                <div className="Section1__content__inner__text" style={{color:"#FFFFFF"}}>
                                    Hát Xoan còn là một hình thức nghệ thuật đa yếu tố, kết hợp giữa ca, nhạc, hát và múa, phục vụ nhu cầu tín ngưỡng của người dân. Khác với các loại hình dân ca khác, Hát Xoan phải hát trong lòng đình, trước bàn thờ thần, tạo nên một bầu không khí trang nghiêm và thành kính.
                                </div>
                            </div>
                            <div className="Section1__content__inner__row__image">
                                <div className="Section1__content__inner__video" style={{margin: "0px"}}>
                                    <iframe width="100%" height="200px" src="https://www.youtube.com/embed/bK2xYXlwzH8?si=mP_Qxy8A9FocTM6-" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                                </div>
                                <div className="Section1__content__inner__video__disc" style={{color:"#FFFFFF"}}>
                                    Nguồn: <b>Báo Nhân Dân</b>
                                </div>
                    ...
                    <div className="Section1__content__inner inner2">
                        <div className="Section1__content__inner__row">
                            <div className="Section1__content__inner__row__text">
                                <div className="Section1__content__inner__title" style={{color:"#FFFFFF"}}>
                                    Làng Xoan giữ hồn di sản 
                                </div>
                                <div className="Section1__content__inner__text" style={{color:"#FFFFFF"}}>
                                    Hát Xoan có tổ chức hết sức chặt chẽ. Những người đi hát thường sống cùng chòm xóm và tổ chức thành phường, gọi là phường Xoan (hay họ Xoan). Hằng năm, các họ Xoan ở vùng đất Tổ lần lượt hát khai xuân ở miếu đình làng xã, sau đó sẽ đi hát lần lượt ở nơi khác.
                                </div>
                                <div className="Section1__content__inner__text" style={{color:"#FFFFFF"}}>
                                    Những làn điệu Xoan cổ bắt nguồn từ các làng cổ nằm ở trung tâm bộ Văn Lang thời Hùng Vương dựng nước, phân bố dọc theo hai bờ sông Lô và sông Thao, tạo thành một dải văn hóa đặc sắc bao quanh núi Hùng. Đứng đầu mỗi phường Xoan là ông Trùm, người có kinh nghiệm về nghề nghiệp, giao tiếp xã hội và am hiểu văn tự, có khả năng hát dẫn các bài hát dài được chép lại.
                                </div>
                                <div className="Section1__content__inner__text" style={{color:"#FFFFFF"}}>
                                    Chính nhờ tổ chức chặt chẽ và sự gắn bó mật thiết với cộng đồng, Hát Xoan đã bảo tồn được nhiều yếu tố lịch sử, văn hóa của thời đại bình minh dựng nước.
                                </div>
                            </div>
                            <div className="Section1__content__inner__row__image">
                                ...
                                <div className="Section1__content__inner__video__disc" style={{color:"#FFFFFF"}}>
                                    Nguồn: <b>Chuyên trang Pháp luật Dân tộc và Tôn giáo - Báo Công Lý</b>
                                </div>
                            </div>
                        </div>
                        {/* <div className="Section1__content__inner__text">
                    ...
                    <div className="Section1__content__inner inner3">
                        <div className="Section1__content__inner__row">
                            <div className="Section1__content__inner__row__text">
                                <div className="Section1__content__inner__title" style={{color:"#FFFFFF"}}>
                                    Trình tự ba phần chặt chẽ 
                                </div>
                                <div className="Section1__content__inner__text" style={{color:"#FFFFFF"}}>
                                    Hát Xoan có một phương thức trình diễn được hình thành từ rất lâu đời, đó là lề lối, là quy chế truyền thống của Hát Xoan. Một cuộc Hát Xoan được chia thành 3 giai đoạn và trình diễn theo một thứ tự nhất định. 
                                </div>
                                <div className="Section1__content__inner__text" style={{color:"#FFFFFF"}}>
                                    Mở đầu một cuộc Hát Xoan là Chặng hát lễ nghi với các ca từ, giọng hát, điệu múa chặt chẽ, trang nghiêm, thành kính. 
                                </div>
                                <div className="Section1__content__inner__text" style={{color:"#FFFFFF"}}>
                                    Chặng thứ hai là đến phần hát cách (còn gọi là quả cách) với giọng điệu, lời lẽ cởi mở, vui tươi, khỏe khoắn, chữ tình thể hiện niềm vui trong lao động sản xuất, trong đời sống lứa đôi…
                                </div>
                                <div className="Section1__content__inner__text" style={{color:"#FFFFFF"}}>
                                    Chặng cuối là hát hội, hát giã đám, hát giao duyên nam nữ, hát giao lưu giữa người trình diễn Hát Xoan với nhân dân địa phương và người đến xem hát, với giọng điệu khỏe mạnh, dồn dập tạo niềm vui, sự hào hứng cho cả người hát và người xem hát.
                                </div>
                                <div className="Section1__content__inner__text" style={{color:"#FFFFFF"}}>
