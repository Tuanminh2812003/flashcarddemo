                        ...
                        <div className="Section5__inner__row1">
                            <div className="Section5__inner__row1__text">
                                ...
                                <div className="Section5__inner__text2">
                                    Từ xa xưa, Vịnh Hạ Long đã được tạo dựng bởi những sức mạnh địa chất. Theo quan niệm của người dân Việt xưa cùng với trí tưởng tượng phong phú mà nhiều hình tượng và truyền thuyết về nguồn gốc được hình thành. Một trong những tượng hình đó là hình ảnh của Rồng và Tiên.
                                </div>
                                <div className="Section5__inner__text2">
                                    Người Việt kể rằng trong lịch sử xa xưa, khi người Việt đang gặp khó khăn trước cuộc tấn công của giặc xâm lược, người dân tưởng tượng Ngọc Hoàng đã sai một con Rồng mẹ và một đàn Rồng con đến hạ giới.
                                </div>
                                <div className="Section5__inner__text2">
                                    Đàn Rồng này đã phun lửa để thiêu cháy thuyền của giặc và thả ra viên ngọc châu những viên ngọc này sau đó biến thành những hòn đảo đá vôi hùng vĩ, tạo thành bức tường thành vững chắc, chặn đứng bước tiến của quân xâm lược. Điều này đã đảm bảo sự bình yên cho người dân.
                                </div>
                                <div className="Section5__inner__text2">
                                    Sau khi giặc bỏ đi và cuộc sống trở lại bình thường, người dân nơi đây đã cùng nhau lao động, đoàn kết và giúp đỡ lẫn nhau. Rồng mẹ và Rồng con đã không trở về trời mà đã ở lại hạ giới để bảo vệ những người dân của Việt Nam.
                                </div>
                                <div className="Section5__inner__text2">
                                    Theo truyền thuyết, Rồng mẹ chính là biểu tượng của vịnh Hạ Long, Rồng con đáp xuống tại Bái Tử Long. Và nơi Rồng quẫy đuôi để làm nước trắng xóa là Bạch Long Vĩ. Tuy nhiên, những tên gọi này chỉ được sử dụng từ thời kỳ Pháp thuộc.
                                </div>
                            </div>
                            ...
                            >
                                    ...
                                    style={{backgroundImage: "url('/vinhhalong/9.jpg')",}}
                                >

                                </div>
                                <div className="Section1__content__inner__video__disc">
                                    Ảnh: <b>“Truyền thuyết về vịnh Hạ Long”</b>
                                </div>
                                <div className="Section1__content__inner__video__disc">
                                    Nguồn: <b>Tranh vẽ Bùi Thanh Thủy</b>
                                </div>
                            </div>
                        </div>
