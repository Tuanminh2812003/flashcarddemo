            ...
            <div className="Section1__menu">
                <div className="container">
                    <div className="Section1__menu__inner">
                        <label className="Section1__menu__inner__tab lable1" for="inner1p2" style={{color:"#FFFFFF"}}>Giá trị nổi bật của Châu bản</label>
                        <label className="Section1__menu__inner__tab lable2" for="inner2p2" style={{color:"#FFFFFF"}}>Hình thức ngự phê trên Châu bản</label>
                    </div>
                </div>
            </div>
            <div className="Section1__content">
                <div className="container">
                        ...
                        <div className="Section1__content__inner__row">
                            <div className="Section1__content__inner__row__text">
                                <div className="Section1__content__inner__title" style={{color:"#FFFFFF"}}>
                                    Giá trị nổi bật của Châu bản
                                </div>
                                <div className="Section1__content__inner__text" style={{color:"#FFFFFF"}}>
                                    <b>Tính độc đáo của Châu bản: </b>Thể hiện qua việc ngự phê trực tiếp của các vị vua triều Nguyễn bằng mực son trên văn bản, đây là tài liệu hành chính hiếm hoi lưu giữ được khá đầy đủ bút tích của các vị vua.
                                </div>
                                <div className="Section1__content__inner__text" style={{color:"#FFFFFF"}}>
                                    <b>Tính chính xác cao: </b>Trên mỗi văn bản đều được ghi rõ thông tin thời gian ban hành và được đóng dấu của vua, với quy trình soạn thảo, ban hành, luân chuyển, giải quyết văn bản cũng như hệ thống con dấu đóng trên văn bản được quy định chặt chẽ về thẩm quyền, loại hình, thể thức tạo nên tính xác thực và pháp lý chặt chẽ của Châu bản triều Nguyễn.
                                </div>
                                <div className="Section1__content__inner__text" style={{color:"#FFFFFF"}}>
                                    <b>Ý nghĩa và tầm ảnh hưởng quốc tế: </b>Châu bản được xem là các văn thư hành chính hình thành trong hoạt động quản lý nhà nước của triều Nguyễn, phản ánh toàn bộ các hoạt động nội trị và ngoại giao của triều Nguyễn. 
                                </div>
                                <div className="Section1__content__inner__text" style={{color:"#FFFFFF"}}>
                                Châu bản trở thành những tư liệu quý giá, cung cấp thông tin hữu ích về các lĩnh vực như: nghiên cứu lịch sử, hành chính học, văn bản học, gia phả học, ấn chương học...
                                </div>
                            </div>
                            <div className="Section1__content__inner__row__image">
                                <div className="Section1__content__inner__image" >
                                    <img src="/image/chaubantrieunguyen/5.jpg" />
                                </div>
                                <div className="Section1__content__inner__video__disc" style={{color:"#FFFFFF"}}>
                                    Ảnh: <b>“Bản Dụ Cần vương duy nhất trong Châu bản triều Nguyễn đề ngày 12 tháng 6 năm Hàm Nghi nguyên niên (1885)”</b>
                                </div>
                                <div className="Section1__content__inner__video__disc" style={{color:"#FFFFFF"}}>
                                    Nguồn: <b>Trung tâm Lưu trữ quốc gia I/Châu bản triều Nguyễn</b>
                                </div>
                                <div className="Section1__content__inner__image" >
                                    <img src="/image/chaubantrieunguyen/6.jpg" />
                                </div>
                                <div className="Section1__content__inner__video__disc" style={{color:"#FFFFFF"}}>
                                    Ảnh: <b>“Châu bản triều Nguyễn ngày 22-11 năm Minh Mệnh thứ 14 (1833) khẳng định Hoàng Sa và Trường Sa là của người Việt Nam”</b>
                                </div>
                                <div className="Section1__content__inner__video__disc" style={{color:"#FFFFFF"}}>
                                    Nguồn: <b>Sở Nội vụ Vĩnh Phúc</b>
                                </div>
                                <div className="Section1__content__inner__image" >
                                    <img src="/image/chaubantrieunguyen/7.jpg" />
                                </div>
                                <div className="Section1__content__inner__video__disc" style={{color:"#FFFFFF"}}>
                                    Ảnh: <b>“Châu bản Triều Nguyễn năm Minh Mệnh thứ 18 (1837) khẳng định Hoàng Sa và Trường Sa là của người Việt Nam”</b>
                                </div>
                                <div className="Section1__content__inner__video__disc" style={{color:"#FFFFFF"}}>
                                    Nguồn: <b>Sở Nội vụ Vĩnh Phúc</b>
                                </div>
                    ...
                    <div className="Section1__content__inner inner2p2">
                        ...
                        <div className="Section1__content__inner__row__text">
                                <div className="Section1__content__inner__title" style={{color:"#FFFFFF"}}>
                                    HÌNH THỨC NGỰ PHÊ TRÊN CHÂU BẢN 
                                </div>
                                <div className="Section1__content__inner__text" style={{color:"#FFFFFF"}}>
                                ...
                                <div className="Section1__content__inner__text" style={{color:"#FFFFFF"}}>
                                    Châu mạt (硃 抹) là nét son được phẩy lên tên người hoặc vấn đề nào đó thể hiện sự lựa chọn hoặc không chấp thuận của nhà vua.
                                </div>
                                <div className="Section1__content__inner__text" style={{color:"#FFFFFF"}}>
                                    Châu sổ (硃 数) là nét son được gạch sổ trực tiếp lên những chổ cần sửa chữa hoặc không được chấp thuận. 
                                </div>
                                <div className="Section1__content__inner__text" style={{color:"#FFFFFF"}}>
                                    Châu cải (硃 改) là là chữ, câu, đoạn viết bên cạnh những chữ đã sổ bỏ nhằm sửa lại hoặc thể hiện quan điểm của nhà vua. 
                                </div>
                            </div>
                            <div className="Section1__content__inner__row__image">
                                <div className="Section1__content__inner__image" >
                                    <img src="/image/chaubantrieunguyen/2.1new.jpg" />
                                </div>
                                <div className="Section1__content__inner__video__disc" style={{color:"#FFFFFF"}}>
                                    Ảnh: <b>“Hình thức Châu điểm trên Châu bản triều Nguyễn”</b>
                                </div>
                                <div className="Section1__content__inner__video__disc" style={{color:"#FFFFFF"}}>
                                    Nguồn: <b>Trung tâm Lưu trữ quốc gia I</b>
                                </div>
                                <div className="Section1__content__inner__image" >
                                    <img src="/image/chaubantrieunguyen/2.2new.jpg" />
                                </div>
                                <div className="Section1__content__inner__video__disc" style={{color:"#FFFFFF"}}>
                                    Ảnh: <b>“Ngự phê của vua Minh Mạng năm 1926”</b>
                                </div>
                                <div className="Section1__content__inner__video__disc" style={{color:"#FFFFFF"}}>
                                    Nguồn: <b>Trung tâm Lưu trữ quốc gia I</b>
                                </div>
                                <div className="Section1__content__inner__image" >
                                    <img src="/image/chaubantrieunguyen/2.3new.jpg" />
                                </div>
                                <div className="Section1__content__inner__video__disc" style={{color:"#FFFFFF"}}>
                                    Ảnh: <b>“Châu khuyên trên Châu bản triều Nguyễn”</b>
                                </div>
                                <div className="Section1__content__inner__video__disc" style={{color:"#FFFFFF"}}>
                                    Nguồn: <b>Trung tâm Lưu trữ quốc gia I</b>
                                </div>
                                <div className="Section1__content__inner__image" >
                                    <img src="/image/chaubantrieunguyen/2.4new.jpg" />
                                </div>
                                <div className="Section1__content__inner__video__disc" style={{color:"#FFFFFF"}}>
                                    Ảnh: <b>“Châu mạt trên Châu bản triều Nguyễn”</b>
                                </div>
                                <div className="Section1__content__inner__video__disc" style={{color:"#FFFFFF"}}>
                                    Nguồn: <b>Trung tâm Lưu trữ quốc gia I</b>
                                </div>
                                <div className="Section1__content__inner__image" >
                                    <img src="/image/chaubantrieunguyen/2.5new.jpg" />
                                </div>
                                <div className="Section1__content__inner__video__disc" style={{color:"#FFFFFF"}}>
                                    Ảnh: <b>“Hoàng đế Khải Định phê duyệt trên bản Tấu của Bộ Lễ quy định mỗi tháng ngự triều nghe chính sự 3 kỳ vào các ngày mồng 1, 11, 21 tại điện Văn Minh”</b>
                                </div>
                                <div className="Section1__content__inner__video__disc" style={{color:"#FFFFFF"}}>
                                    Nguồn: <b>Trung tâm Lưu trữ quốc gia I</b>
                                </div>
                                <div className="Section1__content__inner__image" >
                                    <img src="/image/chaubantrieunguyen/2.6new.jpg" />
                                </div>
                                <div className="Section1__content__inner__video__disc" style={{color:"#FFFFFF"}}>
                                    Ảnh: <b>“Châu cải trên Châu bản triều Nguyễn”</b>
                                </div>
                                <div className="Section1__content__inner__video__disc" style={{color:"#FFFFFF"}}>
                                    Nguồn: <b>Trung tâm Lưu trữ quốc gia I</b>
                                </div>
