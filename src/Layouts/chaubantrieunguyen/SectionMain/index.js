    ...
    return(
        <>
            <div className="SectionMain" style={{
                backgroundImage: "url('/image/chaubantrieunguyen/1.png')",
                ...
                <div className="container">
                    <div className="SectionMainP2__inner">
                        <div className="SectionMainP2__inner__title">
                            Dự án Heritage Flash XR Chào mừng quý khách đến trải nghiệm về di sản Châu bản triều Nguyễn!
                        </div>
                        <div className="SectionMainP2__inner__disc">
                            Tham gia trải nghiệm về Châu bản triều Nguyễn quý khách sẽ:
                        </div>
                        <ul>
                            <li>
                                Nắm được thông tin khái quát về di sản Châu bản triều Nguyễn.
                            </li>
                            <li>
