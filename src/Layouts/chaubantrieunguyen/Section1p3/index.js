            ...
            <div className="Section1__menu">
                <div className="container">
                    <div className="Section1__menu__inner">
                        <label className="Section1__menu__inner__tab lable1" for="inner1p3">Triều Nguyễn và Quần đảo Hoàng Sa</label>
                        <label className="Section1__menu__inner__tab lable2" for="inner2p3">Chuyện về các đoàn khảo sát Quần đảo Hoàng Sa và quần đảo Trường Sa của triều Nguyễn</label>
                        <label className="Section1__menu__inner__tab lable3" for="inner3p3">Cứu hộ thuyền bôn nước ngoài trong Châu bản</label>
                    </div>
                </div>
            </div>
                ...
                <div className="container">
                        ...
                        <div className="Section1__content__inner__row">
                            ...
                            <div className="Section1__content__inner__row__image">
                                <div className="Section1__content__inner__image" >
                                    <img src="/image/chaubantrieunguyen/3.1new.jpg" />
                                </div>
                    ...
                    <div className="Section1__content__inner inner2p3">
                        <div className="Section1__content__inner__row">
                            ...
                            <div className="Section1__content__inner__row__image">
                                <div className="Section1__content__inner__image" >
                                    <img src="/image/chaubantrieunguyen/3.2new.png" />
                                </div>
                                <div className="Section1__content__inner__video__disc">
                                ...
                                <div className="Section1__content__inner__image" >
                                    <img src="/image/chaubantrieunguyen/3.22new.png" />
                                </div>
                                <div className="Section1__content__inner__video__disc">
                                    Ảnh: <b>“Châu bản số 6”</b>
                                </div>
                                ...
                                <div className="Section1__content__inner__image" >
                                    <img src="/image/chaubantrieunguyen/3.3new.jpg" />
                                </div>
                                <div className="Section1__content__inner__video__disc">
                    ...
                    <div className="Section1__content__inner inner3p3">
                        <div className="Section1__content__inner__row">
                            ...
                            <div className="Section1__content__inner__row__image">
                                <div className="Section1__content__inner__image" >
                                    <img src="/image/chaubantrieunguyen/3.4new.jpg" />
                                </div>
                                <div className="Section1__content__inner__video__disc">
                                    Ảnh: <b>“Châu bản 1”</b>
                                </div>
