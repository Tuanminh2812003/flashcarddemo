                        ...
                        <div className="Section5__inner__row1">
                            <div className="Section5__inner__row1__text">
                                ...
                                <div className="Section5__inner__text2" style={{color:"#374151"}}>
                                    Tất cả nội dung các bản thảo được khắc trên mộc bản đều được hoàng đế trực tiếp ngự lãm, phê duyệt bằng bút tích trước khi giao cho những người thợ tài hoa nhất trong cung đình khắc lên gỗ quý. Gỗ dùng làm ván khắc Mộc bản triều Nguyễn cũng rất đặc biệt, là gỗ thị, gỗ lê, gỗ táo hay gỗ cây nha đồng, vừa mềm, vừa mịn, thớ gỗ trắng, sáng ngời như ngà voi. Nét chữ khắc trên mộc bản rất điêu luyện, tinh xảo và sắc nét. Với giá trị đặc biệt về nội dung, nghệ thuật chế tác, Mộc bản triều Nguyễn là di sản tư liệu thế giới đầu tiên của Việt Nam được UNESCO công nhận ngày 31 tháng 7 năm 2009. Mộc bản triều Nguyễn trong hồ sơ di sản được đánh giá như sau:
                                </div>
                                <div className="Section5__inner__text2" style={{color:"#374151"}}>
                            ...
                            >
                                    ...
                                    style={{backgroundImage: "url('/mocbantrieunguyen/4.png')",
                                ...
                                <div className="Section1__content__inner__video__disc" style={{color:"#374151"}}>
                                    Ảnh: <b>“Bằng của UNESCO công nhận Mộc bản triều Nguyễn là Di sản Tư liệu thế giới”</b>
                                </div>
                                <div className="Section1__content__inner__video__disc" style={{color:"#374151"}}>
                                    Nguồn: <b>Trung tâm Văn thư Lưu trữ khu vực IV</b>
                                </div>
                            </div>
                        </div>
