                    ...
                    <div className="Section1__content__inner__row">
                            <div className="Section1__content__inner__row__text">
                                ...
                                <div className="Section1__content__inner__text" style={{color:"#FFFFFF"}}>
                                    Mộc bản là chứng tích lịch sử quý báu, là công cụ quan trọng trong việc truyền tải kiến thức và bảo tồn văn hóa. Hiện 34.555 tấm mộc bản đang được bảo quản tại Trung tâm Lưu trữ Quốc gia IV - trực thuộc Cục Văn thư và Lưu trữ Nhà nước, có nội dung rất phong phú và được chia làm chín chủ đề: lịch sử, địa lý, quân sự, pháp chế, văn thơ, tôn giáo - tư tưởng - triết học, ngôn ngữ - văn tự, chính trị - xã hội, văn hóa - giáo dục.
                                </div>
                            </div>
                            <div className="Section1__content__inner__row__image">
                                ...
                                <div className="Section1__content__inner__video__disc" style={{color:"#FFFFFF"}}>
                                    Nguồn: <b>Trung tâm Bảo tồn Di sản Thăng Long - Hà Nội</b>
                                </div>
                            </div>
                        </div>
