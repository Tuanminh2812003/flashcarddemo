    ...
    return(
        <>
            <div className="SectionMain" style={{
                backgroundImage: "url('/dothicohoian/1.png')",
                ...
                <div className="container">
                    <div className="SectionMainP2__inner">
                        <div className="SectionMainP2__inner__title">
                            Dự án Heritage Flash XR Chào mừng quý khách đến trải nghiệm về Đô thị cổ Hội An!
                        </div>
                        <div className="SectionMainP2__inner__disc">
                            Tham gia trải nghiệm về Đô thị cổ Hội An quý khách sẽ:
                        </div>
                        <ul>
                            <li>
                                Xác định được vị trí và giới thiệu được khái quát về di sản Đô thị cổ Hội An.
                            </li>
                            <li>
                                Biết cách sưu tầm và sử dụng tư liệu lịch sử để tìm hiểu về Đô thị cổ Hội An.
                            </li>
                            <li>
