                        ...
                        <div className="Section1__content__inner__row">
                            <div className="Section1__content__inner__row__text">
                                ...
                                <div className="Section1__content__inner__text">
                                    Đô thị cổ Hội An nằm ở vùng hạ lưu ngã 3 sông Thu Bồn, thuộc vùng đồng bằng ven biển tỉnh Quảng Nam, cách thành phố Ðà Nẵng 28 km về phía Nam; phía Ðông giáp biển Ðông; phía Nam giáp huyện Duy Xuyên; phía Tây và Bắc giáp huyện Ðiện Bàn.
                                </div>
                            </div>
                            <div className="Section1__content__inner__row__image">
                                ...
                                <div className="Section1__content__inner__video__disc">
                                    Nguồn: <b>Báo Du lịch Thành phố Hồ Chí Minh</b>
                                </div>
                            </div>
                        </div>
                        {/* <div className="Section1__content__inner__text">
                    ...
                    <div className="Section1__content__inner inner2">
                        <div className="Section1__content__inner__row">
                            <div className="Section1__content__inner__row__text">
                                ...
                                <div className="Section1__content__inner__text">
                                    Trước thế kỉ XV, Hội An là một phần của cảng biển Chămpa. Sau sự suy vong của Chămpa, Hội An trở thành lãnh thổ của Đại Việt. Vì vậy, Hội An được hình thành dựa trên sự kế thừa cảng biển của người Chăm và người Việt bắt đầu tới đây từ thế kỷ 15. Phố cổ Hội An từng là một thương cảng quốc tế sầm uất, là trung tâm buôn bán nối liền ba miền Bắc, Trung, Nam. Được coi là điển hình đặc biệt tiêu biểu về cảng thị truyền thống ở Đông Nam Á với những công trình kiến trúc truyền thống có từ thế kỉ 17 đến thế kỉ 19. Đầu thế kỷ 20, tuy mất đi vai trò cảng thị quan trọng, hoạt động buôn bán ở Hội An chưa khi nào chấm dứt.
                                </div>
                            </div>
                            <div className="Section1__content__inner__row__image">
                                <div className="Section1__content__inner__image" >
                    ...
                    <div className="Section1__content__inner inner3">
                        <div className="Section1__content__inner__row">
                            <div className="Section1__content__inner__row__text">
                                ...
                                <div className="Section1__content__inner__text">
                                    Đô thị cổ Hội An có 1.130 di tích, trong đó có 9 di tích đơn lẻ được xếp hạng cấp quốc gia và 8 di tích cấp tỉnh. 
                                </div>
                            </div>
                            <div className="Section1__content__inner__row__image">
                                <div className="Section1__content__inner__video" style={{marginBottom: "0px", marginTop: "0px"}}>
                                    <iframe width="100%" height="200px" src="https://www.youtube.com/embed/lHDuVkIs78o?si=WWiHflsMXCv-Holx" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                                </div>
                                <div className="Section1__content__inner__video__disc">
                                    Video: <b>“Phố cổ Hội An”</b>
                                </div>
                            </div>
                        </div>
