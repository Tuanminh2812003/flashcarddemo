...
function Section1(){
    return(
        ...
        <div style={{backgroundColor:"#FEF2F2", padding: "40px 0px"}}>
            ...
            <input type="radio" id="inner1p2" name="section2" defaultChecked/>
                    ...
                    <div className="Section1__content__inner inner1p2">
                        <div className="Section1__content__inner__row">
                            <div className="Section1__content__inner__row__text">
                                ...
                                <div className="Section1__content__inner__text">
                                    Hội An là một đô thị cổ hiếm hoi còn giữ được nhiều công trình kiến trúc truyền thống từ các thế kỷ 16-18, đặc biệt là nhà cổ, chùa, đền, cầu, và các công trình công cộng, là một ví dụ điển hình về một đô thị cổ có cấu trúc và quy hoạch bảo tồn được nguyên vẹn qua hàng thế kỷ. Sự giao thoa văn hóa tại đây đã tạo ra một nền văn hóa thương mại phong phú, đa dạng, với những ảnh hưởng rõ rệt trong kiến trúc, nghệ thuật, và các phong tục tập quán. Tại đây, người dân vẫn duy trì và phát triển những nghề thủ công truyền thống và gìn giữ những lễ hội truyền thống như Lễ hội đèn lồng, Tết Nguyên đán, Lễ hội Trung Thu, Lễ hội cầu an,... Những lễ hội này không chỉ là sự kiện tôn vinh các giá trị văn hóa, mà còn tạo ra không gian giao lưu giữa người dân và du khách. Lễ hội đèn lồng là một trong những sự kiện đặc biệt, khi cả thành phố được chiếu sáng bởi hàng nghìn chiếc đèn lồng lung linh, tượng trưng cho những lời cầu nguyện bình an, hạnh phúc.
                                </div>
                                <div className="Section1__content__inner__text">
                                    Ngày 4-12-1999, tổ chức UNESCO đã ra quyết định công nhận phố cổ Hội An là Di tích Văn hóa thế giới.
                                </div>
                            </div>
