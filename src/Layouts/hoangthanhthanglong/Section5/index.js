                        ...
                        <div className="Section5__inner__row1">
                            <div className="Section5__inner__row1__text">
                                ...
                                <div className="Section5__inner__text2">
                                    Di tích lịch sử và khảo cổ Khu Trung tâm Hoàng thành Thăng Long - Hà Nội nằm trên địa bàn phường Điện Biên và Quán Thánh, quận Ba Đình, thành phố Hà Nội.
                                </div>
                            </div>
                            ...
                            >
                                    ...
                                    style={{backgroundImage: "url('/hoangthanhthanglong/2.1.jpg')",}}
                                >

                                </div>
                                <div className="Section1__content__inner__video__disc">
                                    Ảnh: <b>“Hoàng thành Thăng Long gắn liền với nhiều giai đoạn lịch sử”</b>
                                </div>
                                <div className="Section1__content__inner__video__disc">
