                        ...
                        <div className="Section1__content__inner__row">
                            ...
                            <div className="Section1__content__inner__row__text">
                                <div className="Section1__content__inner__text" style={{color: "#FFFFFF"}}>
                                    Đờn ca tài tử Nam Bộ là một di sản văn hóa quý báu, kết tinh những giá trị văn hóa và tinh thần đặc sắc, góp phần làm phong phú và tô đậm thêm bản sắc văn hóa Việt Nam.
                                </div>
                                <div className="Section1__content__inner__text" style={{color: "#FFFFFF"}}>
                                    Về phương diện văn hóa: Loại hình nghệ thuật này đóng vai trò quan trọng trong việc bảo tồn và phát huy di sản văn hóa phi vật thể của Việt Nam. Nó phản ánh chân thực đời sống văn hóa, xã hội của người dân Nam Bộ thông qua nội dung các bài bản, lời ca mộc mạc, gần gũi, sử dụng phương ngữ và chất liệu văn học dân gian đặc trưng. Hơn nữa, đờn ca tài tử còn là sợi dây gắn kết cộng đồng, tạo không gian giao lưu văn hóa và thúc đẩy sự sáng tạo nghệ thuật không ngừng.
                                </div>
                                <div className="Section1__content__inner__text" style={{color: "#FFFFFF"}}>
                                    Về phương diện tinh thần: Đờn ca tài tử có khả năng bồi dưỡng tâm hồn, tình cảm con người, khơi gợi những cảm xúc tích cực và truyền tải những bài học đạo lý sâu sắc. Nó không chỉ là biểu tượng văn hóa độc đáo của vùng đất Nam Bộ mà còn thể hiện niềm tự hào dân tộc, kết nối các thế hệ và mang đến giá trị giải trí tinh thần lành mạnh.
                                </div>
                                <div className="Section1__content__inner__text" style={{color: "#FFFFFF"}}>
                                    Kết nối cộng đồng: Đờn ca tài tử là cầu nối tinh thần giữa các thế hệ và vùng miền. Tại TP.HCM, có 229 câu lạc bộ với hơn 1.200 nghệ nhân, tài tử đang hoạt động. Ở Tây Ninh, 285 nhóm duy trì sinh hoạt thường xuyên, góp phần gìn giữ bản sắc.
                                </div>
                            </div>
                    ...
                    <div className="Section1__content__inner inner2p2">
                        <div className="Section1__content__inner__row">
                            <div className="Section1__content__inner__row__text">
                                ...
                                <div className="Section1__content__inner__text" style={{color: "#FFFFFF"}}>
                                    Lễ nghi và tín ngưỡng trong Đờn ca tài tử Nam Bộ mang tính chất dân gian, thể hiện sự tôn kính và giao thoa văn hóa, thay vì mang màu sắc tôn giáo cụ thể. Các yếu tố này được biểu hiện qua:
                                </div>
                                <div className="Section1__content__inner__text" style={{color: "#FFFFFF"}}>
                                    - Thờ Tổ nghiệp: Đây là nghi thức quan trọng, thể hiện lòng biết ơn sâu sắc đối với các bậc tiền bối có công khai sáng và phát triển nghệ thuật, đồng thời cầu mong sự phù hộ cho quá trình hành nghề và biểu diễn.
                                </div>
                                <div className="Section1__content__inner__text" style={{color: "#FFFFFF"}}>
                                    - Ảnh hưởng của tín ngưỡng dân gian: Đờn ca tài tử chịu ảnh hưởng từ các tín ngưỡng dân gian phổ biến ở Nam Bộ như thờ Mẫu, thờ Thành hoàng, các vị thần linh và anh hùng dân tộc. Điều này được thể hiện qua nội dung một số bài bản, các câu chuyện dân gian, cũng như những kiêng kỵ nhất định trong quá trình biểu diễn.
                                </div>
                                <div className="Section1__content__inner__text" style={{color: "#FFFFFF"}}>
                                    - Nghi thức trong sinh hoạt: Các nghi thức như thắp nhang xin phép Tổ nghiệp, "khai đờn" trước buổi diễn, hay lễ "tầm sư học đạo" trong quá trình truyền dạy, góp phần tạo nên không khí trang trọng, tôn nghiêm, thể hiện sự kính trọng đối với nghệ thuật và những người làm nghề.
                                </div>
                                <div className="Section1__content__inner__text" style={{color: "#FFFFFF"}}>
                                    - Không gian biểu diễn: Tính linh hoạt của không gian, từ nhà dân, sân đình, trên thuyền, đến sân khấu, phản ánh tính chất dân gian, không bị ràng buộc.
                                </div>
                                <div className="Section1__content__inner__text" style={{color: "#FFFFFF"}}>
                                Tựu trung, lễ nghi và tín ngưỡng trong Đờn ca tài tử Nam Bộ là một phần không thể tách rời, hòa quyện vào đời sống văn hóa, tinh thần, phản ánh sự tôn trọng các giá trị truyền thống, niềm tin tâm linh và sự giao thoa văn hóa đặc trưng của vùng đất Nam Bộ.
                                </div>
                            </div>
                            <div className="Section1__content__inner__row__image">
                                <div className="Section1__content__inner__image" >
