            ...
            <div className="Section4__text">
                {slides.map((_, index) =>
                    ...
                    <div key={index} className="Section4__text__inner">
                        ...
                        {index === 3 &&
                        `Bạch Đằng Giang khắc trên Nghị đỉnh - sông Bạch Đằng là con sông lớn ở đông bắc Tổ quốc, chảy qua các tỉnh thảnh Quảng Ninh, Hải Phòng. Sông Bạch Đằng ghi dấu lịch sử với những trận thuỷ chiến chống quân xâm lược.`}
                        {index === 4 &&
