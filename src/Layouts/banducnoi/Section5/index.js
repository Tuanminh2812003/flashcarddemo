                        ...
                        <div className="Section5__inner__row1">
                            <div className="Section5__inner__row1__text">
                                ...
                                <div className="Section5__inner__text2">
                                    Các đỉnh được làm từ đồng nguyên chất và được đúc bằng phương pháp đúc thủ công truyền thống. Kỹ thuật đúc của Cửu đỉnh rất phức tạp và tinh xảo, với các họa tiết, hình ảnh được chạm khắc nổi trên bề mặt đỉnh một cách chi tiết và tỉ mỉ. Trên bề mặt của mỗi đỉnh, có những bản đúc nổi khắc họa các hình ảnh, các sự kiện lịch sử, các biểu ảnh văn hóa và triều đại nhà Nguyễn. Đây là nguồn tư liệu độc đáo, quý hiếm mang giá trị nội dung về lịch sử, văn hóa - giáo dục, địa lí, phong thủy, y dược, nghệ thuật, thư pháp.
                                </div>
                            </div>
                            ...
                            >
                                    ...
                                    style={{backgroundImage: "url('/banducnoi/4.1.jpg')",}}
                                >

                                </div>
                                <div className="Section1__content__inner__video__disc">
                                    Ảnh: <b>“Những bản đúc trên chín đỉnh đồng ở hoàng cung Huế được công nhận là di sản tư liệu thế giới”</b>
                                </div>
                                <div className="Section1__content__inner__video__disc">
                                    Nguồn: <b>Báo Dân Trí (Vi Thảo)</b>
                                </div>
                            </div>
                        </div>
