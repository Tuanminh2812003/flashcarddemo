...
function Section1p5() {
    ...
    const questionList = [
        {
        question: `Vườn quốc gia Phong Nha - Kẻ Bàng nằm tại tỉnh nào?`,
        options: ["A. Quảng Bình", "B. Quảng Trị", "C. Quảng Ninh", "D. Khánh Hòa"],
        correct: "A. Quảng Bình",
        },
        {
        question: `UNESCO công nhận Phong Nha - Kẻ Bàng là Di sản thiên nhiên thế giới với tiêu chí địa chất và địa mạo vào năm nào??`,
        options: ["A. 2003", "B. 1970", "C. 1980", "D. 1950"],
        correct: "A. 2003",
        },
        {
        question: `Hội nghiên cứu hang động Hoàng gia Anh đã đánh giá Động Phong Nha có bao nhiêu cái nhất?`,
        options: [
            "A. 5",
            "B. 6",
            "C. 7",
        ...
        {
            question: `Vườn quốc gia Phong Nha - Kẻ Bàng có bao nhiêu hang động?`,
            options: ["A. Hơn 100", "B. Hơn 300", "C. Hơn 400", "D. Hơn 500"],
            correct: "B. Hơn 300",
        },
    ];
        ...
        <div className="Section2" style={{backgroundColor: "#FFFFFF"}}>
            ...
            <div className="Section2__inner">
                ...
                <div
                    ...
                    style={{
                    backgroundImage: "url('/vuonquocgia/5.1.png')",
