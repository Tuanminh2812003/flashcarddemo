...
function Section1p2(){
    return(
        <>
        <div style={{backgroundColor:"#1D5136", padding: "40px 0px"}}>

            <div className="Section1__title">
                <div className="container">
                    <div className="Section1__title__inner" style={{color:"white"}}>
                    ...
                    <div className="Section1__content__inner inner1">
                        ...
                        <div className="Section1__content__inner__row">
                            <div className="Section1__content__inner__row__text">
                                <div className="Section1__content__inner__text" style={{color:"white"}}>
                                ...
                                <div className="Section1__content__inner__title" style={{color:"white"}}>
