            ...
            <div className="Section1__menu">
                <div className="container">
                    <div className="Section1__menu__inner">
                        ...
                        <label className="Section1__menu__inner__tab lable1p3" for="inner1p3">Lịch sử hình thành</label>
                        <label className="Section1__menu__inner__tab lable2p3" for="inner2p3">Giới thiệu khái quát </label>
