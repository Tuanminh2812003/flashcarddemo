                    ...
                    <div className="Section5__inner">
                        ...
                        <div className="Section5__inner__row1">
                            <div className="Section5__inner__row1__text">
                                ...
                                <div className="Section5__inner__text2" style={{marginBottom: "24px"}}>
                            ...
                            <div className="Section1__content__inner__video__disc">
                                    Ảnh: <b>"Rừng nguyên sinh đặc dụng Hoa Lư"</b>
                                </div>
                            <div className="Section1__content__inner__video__disc">
                                    Nguồn: <b>Ban quản lý Quần thể danh thắng Tràng An</b>
                                </div>
                            </div>
                        </div>
                    </div>
