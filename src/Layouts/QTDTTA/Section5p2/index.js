            ...
            <div className="Section5" style={{backgroundColor: "#D4E0BD"}}>
                <div className="container">
                    <div className="Section5__inner">
                        <div className="Section5__inner__title" style={{marginBottom: "0px", color: "#374151"}}>
                        ...
                        <div className="Section5__inner__row1">
                            ...
                            <div className="Section1__content__inner__video__disc" style={{color: "#374151"}}>
                                    Ảnh: <b>"Lễ rước 63 thuyền sản vật dâng Thần Nông"</b>
                                </div>
                            <div className="Section1__content__inner__video__disc" style={{color: "#374151"}}>
                                    Nguồn: <b>Khu du lịch Tam Cốc - Bích Động</b>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="Section5__inner__row2">
                            ...
                            <div className="Section1__content__inner__video__disc" style={{color: "#374151"}}>
                                    Ảnh: <b>"Tràng An - vẻ đẹp thiên nhiên hùng vĩ"</b>
                                </div>
                            <div className="Section1__content__inner__video__disc" style={{color: "#374151"}}>
                                    Nguồn: <b>Thông tấn xã Việt Nam</b>
                                </div>
                            </div>
                        </div>
