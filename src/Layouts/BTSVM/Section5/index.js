                ...
                <div className="container">
                    <div className="Section5__inner">
                        ...
                        <div className="Section5__inner__row1">
                            <div className="Section5__inner__row1__text">
                                ...
                                <div className="Section5__inner__text2" style={{color:"#374151"}}>
                                    Đặt tại Văn Miếu – Quốc Tử Giám (Hà Nội)
                                </div>
                            </div>
                            ...
                            <div className="Section5__inner__row1__image">
                                ...
                                <div className="Section1__content__inner__video__disc" style={{color:"#374151"}}>
                                    Ảnh: <b>“Hình ảnh Khuê văn các tại Văn Miếu – Quốc Tử Giám”</b>
                                </div>
                                <div className="Section1__content__inner__video__disc" style={{color:"#374151"}}>
                                    Nguồn: <b>Báo Tổ Quốc (Lam Anh)</b>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="Section5__inner__row2">
                            ...
                            <div className="Section5__inner__row1__image">
                                <iframe width={"100%"} height={"100%"} title="Bia tiến sĩ năm 1442 ( Văn Miếu Quốc Tử Giám)" frameborder="0" allowfullscreen mozallowfullscreen="true" webkitallowfullscreen="true" allow="autoplay; fullscreen; xr-spatial-tracking" xr-spatial-tracking execution-while-out-of-viewport execution-while-not-rendered web-share src="https://sketchfab.com/models/7aac2b6d65764a519fdbc71ceb03227f/embed"> </iframe>
                            </div>
                        </div>
                        ...
                        <div className="Section5__inner__row1">
                            ...
                            <div className="Section5__inner__row1__image">
                                ...
                                <div className="Section1__content__inner__video__disc" style={{color:"#374151"}}>
                                    Ảnh: <b>“Các tấm bia Tiến sĩ tại Văn Miếu – Quốc Tử Giám”</b>
                                </div>
                                <div className="Section1__content__inner__video__disc" style={{color:"#374151"}}>
                                    Nguồn: <b>Lại Tấn </b>
                                </div>
