            ...
            <div className="Section1__menu">
                <div className="container">
                    <div className="Section1__menu__inner">
                        ...
                        <label className="Section1__menu__inner__tab lable1p3" for="inner1p3" style={{color:"#FFFFFF"}}>Giới thiệu khái quát </label>
                        <label className="Section1__menu__inner__tab lable2p3" for="inner2p3" style={{color:"#FFFFFF"}}>Câu chuyện văn bia </label>
                ...
                <div className="container">
                    ...
                    <div className="Section1__content__inner__row">
                            <div className="Section1__content__inner__row__text">
                                ...
                                <div className="Section1__content__inner__text" style={{color:"#FFFFFF"}}>
                                    Những bài ký trên bia Tiến sĩ được viết bằng chữ Hán với những cách viết khác nhau, khiến cho mỗi tấm bia như một tác phẩm thư pháp. 
                                </div>
                                <div className="Section1__content__inner__text" style={{color:"#FFFFFF"}}>
                            ...
                            <div className="Section1__content__inner__row__image">
                                <iframe title="Bia Tiến sĩ Văn Miếu 1659" width={"100%"} height={"100%"} frameborder="0" allowfullscreen mozallowfullscreen="true" webkitallowfullscreen="true" allow="autoplay; fullscreen; xr-spatial-tracking" xr-spatial-tracking execution-while-out-of-viewport execution-while-not-rendered web-share src="https://sketchfab.com/models/2ad27da9e4bc4d5baff067fb4920f74d/embed"> </iframe>
                            </div>
                        </div>
