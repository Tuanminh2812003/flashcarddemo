                    ...
                    <div className="Section5__inner">
                        ...
                        <div className="Section5__inner__row1">
                            <div className="Section5__inner__row1__text">
                                ...
                                <div className="Section5__inner__text2">
                                    Ca trù mang đậm giá trị nghệ thuật biểu diễn: Kỹ thuật thanh nhạc, luyến láy, sử dụng câu từ cũng như cách gõ phách kèm khi hát đòi hỏi người biểu diễn phải có kỹ thuật rất cao. Chỉ bằng ba nhạc cụ đơn giản kết hợp với tiếng hát của ca nương mà đã thể hiện được cảm xúc và nội dung tác phẩm cần biểu đạt. Bên cạnh giá trị nghệ thuật, Ca trù mang tính giải trí cao bởi thời xưa thường biểu diễn trong các dịp lễ hội, họp sân đình.
                                </div>
                            </div>
                            ...
                            >
                                    ...
                                    style={{backgroundImage: "url('/catru/6.1.png')",}}
                                >

                                </div>
                                <div className="Section1__content__inner__video__disc">
                                    Ảnh: <b>“Liên hoan Ca trù Hà Nội lần thứ 3”</b>
                                </div>
                                <div className="Section1__content__inner__video__disc">
                        ...
                        <div className="Section5__inner__row2">
                            <div className="Section5__inner__row1__text">
                                ...
                                <div className="Section5__inner__text2">
                                    Không chỉ mang giá trị nội dung, nghệ thuật cao, Ca trù còn mang tính xã hội bởi chúng thường diễn tả lại những câu chuyện đời thường, tích sử được cốt truyện có thực đi theo từng giai đoạn lịch sử của Việt Nam. Tuy nhiên sự ảnh hưởng của bối cảnh lịch sử xã hội không ảnh hưởng quá lớn tới nội dung và biểu diễn bởi các giáo phường thì thường đi theo các lối nhất định, chỉ có các giáo phường trong nhân dân mới thường xuyên đưa các yếu tố xã hội vào trong tác phẩm biểu diễn.
                                </div>
                            </div>
                            <div className="Section5__inner__row1__image"
                            ...
                            >
                                    <div className="Section5__inner__row1__image__inner"
                                    style={{backgroundImage: "url('/catru/6.2.png')",}}
                                >

                                </div>
                                <div className="Section1__content__inner__video__disc">
                                    Ảnh: <b>“Ca trù mang giá trị xã hội”</b>
                                </div>
                                <div className="Section1__content__inner__video__disc">
                                    Nguồn: <b>Báo Ảnh Việt Nam</b>
                                </div>
                            </div>
                        </div>
                        {/* <div className="Section5__inner__row2">
