                        ...
                        <div className="Section5__inner__row1">
                            <div className="Section5__inner__row1__text">
                                ...
                                <div className="Section5__inner__text2">
                                    Ca trù hay còn được biết tới là hát Ả đào, hát nhà trò có nguồn gốc từ thế kỉ XI và phát triển thịnh hành từ thế kỷ XV tại Bắc Bộ và Bắc Trung Bộ nước ta. Đây là loại hình nghệ thuật được giới quý tộc, trí thức cũng như cung đình ưa thích và là sự kết hợp đỉnh cao của thơ ca và âm nhạc.
                                </div>
                            </div>
                            ...
                            >
                                    ...
                                    style={{backgroundImage: "url('/catru/3.png')",}}
                                >

                                </div>
                                <div className="Section1__content__inner__video__disc">
                                    Ảnh: <b>“Ca nương Kim Ngọc và nghệ sĩ đàn đáy Bá Hải thuộc CLB Ca trù Hà Nội.”</b>
                                </div>
                                <div className="Section1__content__inner__video__disc">
                                    Nguồn: <b>Báo Lao Động</b>
                                </div>
                            </div>
                        </div>
