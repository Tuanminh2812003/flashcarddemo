                        ...
                        <div className="Section1__content__inner__row">
                            <div className="Section1__content__inner__row__text">
                                ...
                                <div className="Section1__content__inner__text">
                                    Ca trù hay còn được gọi là hát Ả đào là một biểu tượng văn hóa độc đáo của người Việt. Đây là sự kết hợp giữa âm nhạc, lời ca và nghệ thuật biểu diễn được thể hiện qua hình thức hát đối đáp giữa nhạc công và ca sĩ, với phần hát chủ yếu của nữ nghệ sĩ đảm nhiệm. Ca trù sử dụng các nhạc cụ đặc trưng như trống, đàn đáy tạo nên âm thanh thanh thoát, sâu lắng, mang đậm âm hưởng dân gian.
                                </div>
                            </div>
