            ...
            <div className="Section1__menu">
                <div className="container">
                    <div className="Section1__menu__inner">
                        <label className="Section1__menu__inner__tab lable1" for="inner1">Đôi nét về Hoàng hoa sứ trình đồ</label>
                        <label className="Section1__menu__inner__tab lable2" for="inner2">Tác giả</label>
                    </div>
                </div>
            </div>
                        ...
                        <div className="Section1__content__inner__row">
                            <div className="Section1__content__inner__row__text">
                                <div className="Section1__content__inner__title">
                                    Đôi nét về Hoàng hoa sứ trình đồ
                                </div>
                                <div className="Section1__content__inner__text">
                                    “Hoàng hoa sứ trình đồ” là cuốn sách cổ về hành trình đi sứ Trung Hoa của dòng họ Nguyễn Huy ở Hà Tĩnh. Cuốn sách là một bức tranh vẽ tay một cách tinh tế tỉ mỉ từ cảnh vật, con người, chứa đựng những thông tin quý báu về văn hóa, xã hội và lịch sử quan hệ ngoại giao giữa Việt Nam và Trung Quốc.
                                </div>
                            </div>
                            <div className="Section1__content__inner__row__image">
                                ...
                                <div className="Section1__content__inner__video__disc">
                                    Nguồn: <b>Báo Dân trí (Dương Nguyễn)</b>
                                </div>
                                <div className="Section1__content__inner__video" style={{marginBottom: "0px"}}>
                                    <iframe width="100%" height="200px" src="https://www.youtube.com/embed/wBsVLBsngC0?si=UPg8bHpbSHwakMG7" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                                </div>
                                <div className="Section1__content__inner__video__disc">
                                    Nguồn: <b>“Hoàng hoa sứ trình đồ và những giá trị còn mãi”</b>
                                </div>
