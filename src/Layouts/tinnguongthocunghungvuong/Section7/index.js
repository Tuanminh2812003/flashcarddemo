                ...
                <div className="container">
                    <div className="Section7__inner">
                        ...
                        <div className="Section7__inner__disc">
                            Bạn hãy thiết kế một video/poster hoặc lá thư để thể hiện chủ đề: “Cảm nghĩ sau khi tìm hiểu thông tin về di sản trên website/Đề xuất những biện pháp bảo tồn và quảng bá hình ảnh di sản Tín ngưỡng thờ Mẫu Tam phủ”
                        </div>
                        <div className="Section7__inner__disc">
