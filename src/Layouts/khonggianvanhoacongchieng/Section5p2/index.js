                    ...
                    <div className="Section5__inner">
                        ...
                        <div className="Section5__inner__row1">
                            ...
                            >
                                ...
                                <div className="Section1__content__inner__video__disc">
                                    Ảnh: <b>“Kiệt tác di sản văn hóa Cồng chiêng Tây Nguyên”</b>
                                </div>
                                <div className="Section1__content__inner__video__disc">
                                    Nguồn: <b>Cổng thông tin điện tử Chính phủ</b>
                                </div>
                            </div>
                        ...
                        <div className="Section5__inner__row2">
                            <div className="Section5__inner__row1__text">
                                ...
                                <div className="Section5__inner__text2">
                                    Tuy nhiên, quá trình đổi mới kinh tế - xã hội đã làm thay đổi mạnh mẽ cuộc sống của cộng đồng các dân tộc Tây Nguyên, khiến cho các sinh hoạt truyền thống ngày càng ít đi và cồng chiêng mất đi vị trí như trước. Sự mai một này đặt ra thách thức lớn trong việc bảo tồn và chuyển giao kiến thức cho thế hệ trẻ. Cồng chiêng trở thành di sản đối với người lớn tuổi, trong khi giới trẻ ít gắn bó và các nghệ nhân bảo tồn giá trị văn Cồng chiêng ngày càng hiếm. Việc bảo tồn di sản này là cần thiết để duy trì giá trị văn hóa truyền thống và tạo cơ hội cho thế hệ trẻ học hỏi.
                                </div>
                            </div>
                            <div className="Section5__inner__row1__image"
                            ...
                            >
                                ...
                                <div className="Section1__content__inner__video__disc">
                                    Ảnh: <b>“Bảo tồn và phát huy giá trị văn hóa Cồng chiêng Tây Nguyên”</b>
                                </div>
                                <div className="Section1__content__inner__video__disc">
