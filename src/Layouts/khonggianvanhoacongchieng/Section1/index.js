                        ...
                        <div className="Section1__content__inner__row">
                            ...
                            <div className="Section1__content__inner__row__image">
                                <div className="Section1__content__inner__video" style={{marginTop:"0px"}}>
                                    <iframe width="100%" height="200px" src="https://www.youtube.com/embed/QgC2NPBxNw4?si=03GAkaLXiKG_01r8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                                </div>
                                <div className="Section1__content__inner__video__disc">
                                    Video: <b>“Không gian văn hóa Cồng chiêng Tây Nguyên”</b>
                                </div>
                            </div>
                        </div>
